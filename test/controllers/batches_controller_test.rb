...
class BatchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create batch" do
    assert_difference('Batch.count') do
      post batches_url, params: { batch: { code: @batch.code, end_year: @batch.end_year, start_year: @batch.start_year } }
    end
  ...
  test "should update batch" do
    patch batch_url(@batch), params: { batch: { code: @batch.code, end_year: @batch.end_year, start_year: @batch.start_year } }
