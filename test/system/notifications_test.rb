...
class NotificationsTest < ApplicationSystemTestCase
  ...
  test "creating a Notification" do
    ...
    fill_in "Batch", with: @notification.batch_id
    fill_in "Course", with: @notification.course_id
    fill_in "Department", with: @notification.department_id
    fill_in "Regulation", with: @notification.regulation_id
